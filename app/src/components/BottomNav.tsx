...
import { mainNavItems, primaryTripNavItems, moreTripNavItems } from '../config/navItems';

// Mobile only — Sidebar takes over at the lg breakpoint (see issue #9).
// The 4 highest-traffic trip surfaces stay always visible with icon+label,
...
export function BottomNav() {
    ...
    if (tripId) {
        ...
        return (
            <>
                <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-bg-card)] border-t border-[var(--color-border)] pb-[env(safe-area-inset-bottom)] z-40">
                ...
                {moreOpen && (
                    <div
                        className="lg:hidden fixed inset-0 z-50 flex items-end justify-center bg-black/50"
